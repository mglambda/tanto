...
("CTRL+e", lambda: self.seekPercentage(100),
        ...
        ("j", self.setHead,
         C_PROGRAM, "set the head to point at the currently selected track and clip. ALT+j to unset."),
        ("ALT+j", self.unsetHead,
         C_PROGRAM, "Clear the head position so it doesn't point at anything."),
        ("J", self.whereIsHead,
